...
const SearchForm = () => {
  ...
  const handleSubmit = () => {
    ...
    const url = `https://nws.cwa.sellercloud.com/Inventory/ManageInventory.aspx?ProductTypeId=Laptops&keywords=${keywords}&CC_HARDDRIVECAPACITY=${hardDrive}&CC_RAM=${ram}&CC_PROCESSORSERIES=${procSeries}&inventoryFrom=${minQuantity}&CC_BRAND2=${brand}`;
